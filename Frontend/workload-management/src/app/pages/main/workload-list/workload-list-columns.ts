...
export const ColumnsForWorkloadList: WorkloadColumnSettings[] = [
  ...
  { collection: 'columnsForWorkloadClasses', name: 'programma', pathTo: 'classProgram', sortable: true, visible: true, style: 'workloadClass-header', isMain: false },
  { collection: 'columnsForWorkloadClasses', name: 'Kurss', pathTo: 'classLevelAndProgram', sortable: false, visible: true, style: 'workloadClass-header', isMain: false },
