...
export class RegisterComponent {
  registerRequest: RegistrationRequest = {email: '', name: '', surname: '', password: ''};
  ...
  onSubmit()
  {
    ...
    this.registerRequest.name = this.form.value.firstName ?? '';
    this.registerRequest.surname = this.form.value.lastName ?? '';
    this.errorMsg = [];
