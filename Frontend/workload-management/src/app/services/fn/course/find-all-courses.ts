...
export function findAllCourses(http: HttpClient, rootUrl: string, params?: FindAllCourses$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CourseResponse>>> {
